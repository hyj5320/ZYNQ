...
# Path of this script: C:\verilog\target_board\project_1\workspace2\eth_test_system\_ide\scripts\debugger_eth_test-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\verilog\target_board\project_1\workspace2\eth_test_system\_ide\scripts\debugger_eth_test-default.tcl
# 
...
set bp_12_57_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_12_57_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
